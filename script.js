...
const translations = [
  ...
  ['.adults-only', 'For organisational reasons, we have chosen to hold an adults-only reception.', "Pour des raisons d'organisation nous avons choisi une réception sans enfants."],
